...
#define STACKKEYS(MOD, ACTION)                                                 \
  {MOD, XK_j, ACTION##stack, {.i = INC(+1)}},                                  \
      {MOD,                                                                    \
       ...
       ACTION##stack,                                                          \
       {.i = INC(                                                              \
            -1)}}, /* { MOD, XK_grave, ACTION##stack, {.i = PREVSEL } }, \ */
...
static Key keys[] = {
    ...
    /* mod+shifht+q can be used for something else */
    ...
    /*    {MODKEY | ShiftMask, XK_l, spawn, SHCMD("setxkbmap")}, */
    ...
    {0, XF86XK_MonBrightnessUp, spawn, SHCMD("brightnessctl s 75+")},
    {0, XF86XK_MonBrightnessDown, spawn, SHCMD("brightnessctl s 75-")},
